    ...
    <section className="w-11/12 lg:p-12 flex justify-center align-middle items-center mx-auto mt-10">
        <section className="grid grid-cols-2 gap-6  gap-y-10  md:grid-cols-2 lg:grid-cols-3 ">
            ...
            <section className=" px-2 w-[125px] md:w-[300px] rounded-2xl shadow-2xl lg:w-[300px] "data-aos="fade-up">
                <div className="max-w-[100%] object-cover mx-auto"><img className="w-full" src="images/Rectangle 16 (13).png" alt=""/></div>
            ...
            <section className=" px-2 w-[125px] md:w-[300px] rounded-2xl shadow-2xl lg:w-[300px] "data-aos="fade-up">
                <div className="max-w-[100%] object-cover mx-auto"><img className="w-full" src="images/Rectangle 17 (13).png" alt=""/></div>
            ...
            <section className=" px-2 w-[125px] md:w-[300px] rounded-2xl shadow-2xl lg:w-[300px] "data-aos="fade-up">
                <div className="max-w-[100%] object-cover mx-auto"><img className="w-full" src="images/Rectangle 18 (13).png" alt=""/></div>
            ...
            <section className=" px-2 w-[125px] md:w-[300px] rounded-2xl shadow-2xl lg:w-[300px] "data-aos="fade-up">
                <div className="max-w-[100%] object-cover mx-auto"><img className="w-full" src="images/Rectangle 16 (12).png" alt=""/></div>
                <div  className="content md:text-xl font-semibold text-sm"><p>LABRADA MUSCLE MASS</p></div>
                <div className="flex justify-between gap-5 pb-3 px-2 align-middle items-center">
                    <div className="text-sm md:text-2xl font-semibold">₹2,999</div>
                    <button className="bg-[#1C96C3] cursor-pointer rounded md:text-2xl text-white butt w-full">BUY NOW</button>
            ...
            <section className=" px-2 w-[125px] md:w-[300px] rounded-2xl shadow-2xl lg:w-[300px] "data-aos="fade-up">
                <div className="max-w-[100%] object-cover mx-auto"><img className="w-full" src="images/Rectangle 17 (12).png" alt=""/></div>
            ...
            <section className=" px-2 w-[125px] md:w-[300px] rounded-2xl shadow-2xl lg:w-[300px] "data-aos="fade-up">
                <div className="max-w-[100%] object-cover mx-auto"><img className="w-full" src="images/Rectangle 18 (12).png" alt=""/></div>
            ...
            <section className=" px-2 w-[125px] md:w-[300px] rounded-2xl shadow-2xl lg:w-[300px] "data-aos="fade-up">
                <div className="max-w-[100%] object-cover mx-auto"><img className="w-full" src="images/Rectangle 16 (11).png" alt=""/></div>
            ...
            <section className=" px-2 w-[125px] md:w-[300px] rounded-2xl shadow-2xl lg:w-[300px] "data-aos="fade-up">
                <div className="max-w-[100%] object-cover mx-auto"><img className="w-full" src="images/Rectangle 17 (11).png" alt=""/></div>
            ...
            <section className=" px-2 w-[125px] md:w-[300px] rounded-2xl shadow-2xl lg:w-[300px] "data-aos="fade-up">
                <div className="max-w-[100%] object-cover mx-auto"><img className="w-full" src="images/Rectangle 18 (11).png" alt=""/></div>
